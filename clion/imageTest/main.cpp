...
//    }
    ...
    int z;
    output = read_mnist_labels("C:/Users/kiril/Projects/clion/NeuralTest/cmake-build-debug/train-labels.idx1-ubyte", z);
    for (int i = 0; i != z; ++i) {
        //cout << (unsigned)output[i] << " ";
    }
    delete [] output;
    cout << z << "\n";
    return 0;
